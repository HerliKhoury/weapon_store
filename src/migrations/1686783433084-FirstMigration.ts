...
export class FirstMigration1686783433084 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "weapon" ("id" SERIAL NOT NULL, "weapon_name" character varying(45) NOT NULL, "price" numeric(9,2) NOT NULL DEFAULT '0', "range" character varying(45) NOT NULL, "availability" boolean NOT NULL DEFAULT true, "weight" numeric(5,2) NOT NULL DEFAULT '0', "categoryId" integer, CONSTRAINT "UQ_b018545f5091250d70b8198fa78" UNIQUE ("weapon_name"), CONSTRAINT "PK_41fe726bde6432339c1d4595d29" PRIMARY KEY ("id"))`);
